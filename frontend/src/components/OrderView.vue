...
const getOrderLogs = () => {
    axios.get(`http://${import.meta.env.VITE_APP_BACKEND_HOST}${import.meta.env.VITE_APP_BACKEND_VERSION}/api/orders/${props.order.id}/logs`, {
        headers: {
...
const collectedMoney = () => {
    axios.post(`http://${import.meta.env.VITE_APP_BACKEND_HOST}${import.meta.env.VITE_APP_BACKEND_VERSION}/api/orders/${props.order.id}/pay`,{}, {
        headers: {
            Authorization: `Bearer ${proxy.$zitadel?.oidcAuth.accessToken}`,
        }
    })
...
const PrintKitchenReceipt = () => {
    axios.post(`http://${import.meta.env.VITE_APP_BACKEND_HOST}${import.meta.env.VITE_APP_BACKEND_VERSION}/api/orders/${props.order.id}/printkitchenreceipt`,{}, {
        headers: {
            Authorization: `Bearer ${proxy.$zitadel?.oidcAuth.accessToken}`,
...
const PrintClientReceipt = () => {
    axios.post(`http://${import.meta.env.VITE_APP_BACKEND_HOST}${import.meta.env.VITE_APP_BACKEND_VERSION}/api/orders/${props.order.id}/printclientreceipt`,{}, {
        headers: {
            Authorization: `Bearer ${proxy.$zitadel?.oidcAuth.accessToken}`,
            "Accept-Language": proxy.$i18n.locale
        }
...
const confirmCancelOrder = (event) => {
    confirm.require({
        ...
        accept: () => {
            ...
            axios.get(`http://${import.meta.env.VITE_APP_BACKEND_HOST}${import.meta.env.VITE_APP_BACKEND_VERSION}/api/orders/${props.order.id}/cancel`, {
                headers: {
                    Authorization: `Bearer ${proxy.$zitadel?.oidcAuth.accessToken}`
                }
            })
